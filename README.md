...
开始陪玩后，直接喊“默默”或设置的名字就会应声；带问题呼叫则回答问题。“陌陌”等常见同音转写和开头感叹词也能识别。直接呼叫不受战斗、画面安全判断和主动发言冷却限制。暂停收听、结束会话或机器人断连时不播放。只喊名字使用本地应答文字，无需等待聊天模型；发声仍需要语音合成服务和本体音频可用。

“热闹一点”适合海克斯大乱斗：战斗中可简短插话，不要求完全安全或画面静止，主动间隔为 8 秒；明显的战局吐槽、甩锅无需先喊名字。其他强度的主动点评仍等待游戏空隙。游戏接口核实本人死亡后，等待复活视为聊天时机；死亡本身不会触发固定安慰播报；有新的具体情况才自然接话，你主动吐槽或叫名字时照常回应。复活或接口过期后撤销死亡窗口，明确暂停主动回应时仍保持安静。
